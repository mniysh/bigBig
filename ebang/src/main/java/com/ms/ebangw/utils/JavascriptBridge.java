...
public class JavascriptBridge {
    ...
    public interface Callback{
         ...
         * @param params
         */
        void onComplate(JSONObject response, String cmd, Bundle params);
    }
     ...
     *
     */
    class JavascriptInterfaceCustom{
        /**
         * 获取需要处理的命令
         * @return 命令数组
         */
        ...
        public void setResult(long serial, String jsonResult){
            ...
            if(command.callback != null && jsonResult != null && !TextUtils.isEmpty(jsonResult)){
                try {
    ...
    public JavascriptBridge(WebView mWebView) {
        ...
        mWebView.addJavascriptInterface(new JavascriptInterfaceCustom(), API_NAMESPACE);
